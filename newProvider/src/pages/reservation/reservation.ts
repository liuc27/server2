...
export class Reservation {
  ...
  ionViewWillEnter() {
    ...
    this.checkLogin.load()
      .then(data => {
        ...
        this.getCalendar.load(this.serviceProviderValidation)
          .then(data2 => {
            var data3 = []
            console.log(data2)
  ...
  onTimeSelected(ev) {
    ...
    if (this.calendar.mode == "month" && this.serviceType == "guide") {
      ...
      if (this.serviceProviderValidation.serviceProviderName)
        confirm1.present();
      ...
      if (alertType === 0) {
      ...
      } else if (this.guideEventSource[theIndex].creatorName === this.serviceProviderValidation.serviceProviderName) {
        let confirm = this.alertCtrl.create({
          title: 'Make reservation?',
          message: 'How many hours do you need?',
          buttons: [
        ...
        console.log("ev")
        console.log(ev)
        console.log(this.serviceProviderValidation.username)
        console.log(this.guideEventSource)
  ...
  createEvents(ev, h: Number) {
    if (h == 9999) {
      ...
      var serviceProviderNameArray = [];
      serviceProviderNameArray.push(this.serviceProviderValidation.serviceProviderName)
      ...
      this.addedEventSource.push({
        ...
        endTime: endTime,
        allDay: false,
        creatorName: this.serviceProviderValidation.serviceProviderName,
        serviceProviderName: serviceProviderNameArray,
        username: [],
  ...
  setReservationDetails() {
    ...
    if (this.serviceProviderValidation.serviceProviderName && this.serviceProviderValidation.password) {
      console.log(this.eventSource)
    ...
    } else if (!this.serviceProviderValidation.serviceProviderName) {
