...
import { ServiceProviderReview } from "../../serviceProvider/serviceProviderDetails/serviceProviderReview/serviceProviderReview";
import { ServiceProviderCertificate } from "../../serviceProvider/serviceProviderDetails/serviceProviderCertificate/serviceProviderCertificate";
...
import { JobReservation } from './jobReservation/jobReservation';
...
openServiceProviderCertificate(certificate){
  ...
  enterReservation() {
    this.nav.push(JobReservation, { user: this.theServiceProvider, serviceType: this.serviceType });
  }
