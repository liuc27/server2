...
import { JobReservationDetails } from '../../../jobOffer/jobOfferDetails/jobReservation/jobReservationDetails/jobReservationDetails';
...
favoriteService(service) {
  ...
  openJobOfferDetailsPage(service) {
    ...
    this.nav.push(JobOfferDetails, service.creator);
  }
