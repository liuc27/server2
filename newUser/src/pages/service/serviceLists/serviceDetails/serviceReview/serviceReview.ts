...
@Component({
  selector: 'page-serviceReview',
  templateUrl: 'serviceReview.html',
...
infiniteScrollEnd = false
  ...
  constructor(private nav: NavController,
    ...
    private http: Http) {
    console.log(params)
    this.serviceDetails = params.data
    ...
    this.http.get(defaultURL+':3000/review/'+this.serviceDetails._id+'?page='+this.page)
      .map(res => res.json())
      .subscribe(
      data => {
            this.page = 1 ;
...
review(){
    ...
    var reviewData: any = {}
    var now = new Date()
    if(this.serviceDetails._id)
    reviewData.discussion_id = this.serviceDetails._id
    ...
    this.http.post(defaultURL+':3000/review/service', reviewData)
      .map(res => res.json())
      .subscribe(
      data => {
            this.presentToast2()
