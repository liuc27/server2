...
@Component({
  selector: 'page-serviceTimeDetails',
  templateUrl: 'serviceTimeDetails.html',
  providers: [UserProvider, OfferProvider]
})
export class ServiceTimeDetails {
  ...
  serviceProviderArray.push({"_id":this.service.creator._id,"id":this.service.creator.id, "nickname":this.service.creator.nickname, "imageURL":this.service.creator.imageURL})
    ...
    if(this.newReservation.startTime&&this.newReservation.endTime&&this.newReservation.userNumberLimit&&this.service.creator){
      this.reservations.push({
        ...
        user: [],
        userNumberLimit: this.newReservation.userNumberLimit,
